$(document).ready(function () {
    ...
    $("#fontsize").click(function () {
        let _this = $(this);
        let _t = $(".single-content");
        let _c = _this.attr("class");
        if (_c == "size_s") {
...
function pr() {
    ...
    let L = document.getElementById("primary");
...
(function ($) {
    ...
    $.fn.textSlider.scllor = function ($this, settings) {
        ...
        let timerID;
        let li = ul.children();
        let _btnUp = $(".up:eq(0)", $this);
        let _btnDown = $(".down:eq(0)", $this);
        let liHight = $(li[0]).height();
        let upHeight = 0 - settings.line * liHight;
...
(function ($) {
    ...
    function write() {
        let content = "<div class=\"ds-dialog\" id='PAY_" + id + "'>"
    ...
    let PaymentUtils = window['PaymentUtils'] = {};
...
$(".comment-reply-link").click(function () {
    ...
    let commentId = $(this).parents('.comment-body').attr("id").match(/\d+/g);
