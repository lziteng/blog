...
<rapid:override name="content">
    ...
    <form class="layui-form" method="post" id="myForm" action="/admin/article/editSubmit">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="articleParentCategoryId" id="articleParentCategoryId" lay-verify="required"
...
//            });
            ...
            form.on("select(articleParentCategoryId)", function () {
                ...
                {
                    str +=
                            "<option name='childCategory' value='${c.categoryId}'<c:if test='${article.categoryList[1].categoryId == c.categoryId}'>selected</c:if>>${c.categoryName}</option>";
                }
                </c:forEach>
