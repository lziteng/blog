...
<rapid:override name="content">
    ...
    <form class="layui-form" method="post" id="myForm"
        ...
        <input type="hidden" name="pageId" value="${page.pageId}" id="pageId">
        <div class="layui-form-item">
            <label class="layui-form-label">别名<span style="color: #FF5722; ">*</span></label>
            <div class="layui-input-inline">
                <input type="text" name="pageKey" lay-verify="key|keyValue" id="key" value="${page.pageKey}"
                       class="layui-input" onblur="checkKeyValue()">
            </div>
            <div class="layui-form-mid layui-word-aux">请填写2到20位，仅允许字母、下划线和减号组成（<span
                    style="color: #FF5722;">请确保别名没重复</span>）
            </div>
            <div class="layui-form-mid layui-word-aux" id="keyValueTips"
                 style="color: #FF5722 !important;font-weight: bold;"></div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea class="layui-textarea layui-hide" name="pageContent" lay-verify="content|myRequired"
