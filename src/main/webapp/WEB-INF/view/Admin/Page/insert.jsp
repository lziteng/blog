    ...
    <form class="layui-form" method="post" id="myForm"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="pageKey" lay-verify="key|keyValue" id="key"
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea class="layui-textarea layui-hide" name="pageContent" value="" lay-verify="content|myRequired"
                          id="content"></textarea>
            </div>
        </div>
