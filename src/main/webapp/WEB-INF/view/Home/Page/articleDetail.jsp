        ...
        <main id="main" class="site-main" role="main">
                ...
                <div class="entry-content">
                    ...
                    <div id="social">
                        <div class="social-main">
                            <span class="like">
                                <a href="javascript:;" data-action="ding" data-id="${article.articleId}" title="点赞"
                                   class="favorite" onclick="increaseLikeCount(this)">
                    ...
                    <footer class="single-footer">
                        <ul class="single-meta">
                            <c:if test="${sessionScope.user!=null && sessionScope.user.userType==1}">
                                <li class="edit-link">
                ...
                <div class="wow fadeInUp" data-wow-delay="0.3s">
                    <aside id="related_post-2" class="widget">
                        ...
                        <div id="related_post_widget">
                            <ul>
                                <c:forEach items="${relatedArticleList}" var="a">
                                    <li>
                                        <a href="/article/${a.articleId}"
                                           title="${a.articleTitle}">${a.articleTitle}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
                    ...
                    <aside id="hot_post-8" class="widget hot_post">
                        ...
                        <div id="hot_post_widget">
                            <ul>
                                <c:forEach items="${mostViewArticleList}" var="a">
                                    <li>
                                        <a href="/article/${a.articleId}" title="${a.articleTitle}">
                                                ${a.articleTitle}
                                        </a>
                                    </li>
                                </c:forEach>
            ...
            <nav class="nav-single">
                ...
                <c:choose>
                    <c:when test="${nextArticle!=null}">
                        <a href="/article/${nextArticle.articleId}" rel="next">
                            <span class="meta-nav">
            ...
            <div id="comments" class="comments-area">
                <div id="respond" class="comment-respond">
                    ...
                    <form id="comment_form" method="post" class="layui-form">
                        <c:if test="${sessionScope.user!=null}">
                            <div class="user_avatar">
                                <img alt="${sessionScope.user.userNickname}"
                                     src="${sessionScope.user.userAvatar}"
                                     class="avatar avatar-64 photo" height="64" width="64">
                                用户：${sessionScope.user.userNickname}
                    ...
                    <c:forEach items="${commentList}" var="c">
                        ...
                        <li class="comment">
                            ...
                            <ul class="children">
                                ...
                                <c:forEach items="${replyCommentList}" var="c2">
...
<rapid:override name="footer-script">
    ...
    <script type="text/javascript">
        ...
        let articleId = $("#articleDetail").attr("data-id");
