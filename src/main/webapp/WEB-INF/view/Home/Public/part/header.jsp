    ...
    <nav id="top-header">
        <div class="top-nav">
            <div class="user-login">
                ...
                <c:if test="${sessionScope.user != null}">
                    欢迎<span style="color:red;">${sessionScope.user.userNickname}</span>!&nbsp;&nbsp;
                    <a href="/logout">退出</a>&nbsp;&nbsp;
                                                ...
                                                <c:if test="${cate.categoryPid==category.categoryId}">
                                                    <li>
                                                        <a href="/category/${cate.categoryId}"
                                                           target="_blank">${cate.categoryName}&nbsp;(${cate.articleCount})</a>
                                                    </li>
                                                </c:if>
                                            </c:forEach>
                                        </ul>
...
<div id="search-main">
    <div class="searchbar">
        <form method="get" id="searchform" action="/search" accept-charset="UTF-8">
            <span>
                <input type="text" value="${keywords}" name="keywords" id="s" placeholder="输入搜索内容" required>
